"""
Django settings for pama_lodge project.
"""
...
WSGI_APPLICATION = 'pama_lodge.wsgi.application'
...
# Only use DATABASE_URL if it's set, not empty, and dj_database_url is available
if DATABASE_URL and isinstance(DATABASE_URL, str) and DATABASE_URL.strip() and dj_database_url:
    DATABASES = {
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='pama_lodge'),
...
# CORS settings
CORS_ALLOWED_ORIGINS_STR = config('CORS_ALLOWED_ORIGINS', default='http://localhost:5173,http://127.0.0.1:5173')
